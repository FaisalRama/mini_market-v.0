...
<!-- Title 2 -->
<form id="FormTrx" method="post" action="pembelian">
<div class="row">
    <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
            <div class="x_title">
                <h2> DETAIL PEMASOK DAN DETAIL PEMBELIAN </h2>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
...
<div class="row">
    <div class="col-md-6 form-group">
        <label for="" class="col-md-4">Tanggal Pembelian</label>
        <div class="col-md-8">
    ...
    <div class="col-md-6 form-group">
        <label for="" class="col-md-4">Pemasok</label>
        <div class="col-md-8">
            <select name="pemasok_id" required="required" class="form-control" >
                @foreach ($pemasok as $pms)
                    <option value="{{ $pms->id }}">{{ $pms->nama_pemasok }}</option>
                @endforeach
            </select>
        </div>
    </div>
